...
def check(config_path, train_path, test_path, num_clients, num_classes, smote=False,niid=False,
...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients,
                num_classes, statistic, smote=False, niid=False, balance=True, partition=None):
    config = {
